      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              href="/#collections"
              className="w-full sm:w-auto px-10 py-5 text-lg font-bold text-center text-white bg-primary rounded-xl hover:bg-primary-hover transition-all transform hover:scale-105 shadow-xl shadow-primary/20"
            >
              Explore Collections
            </Link>
            <Link
